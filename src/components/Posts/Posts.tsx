    ...
    return (    
        <div>
            ...
            <div className="h-screen flex items-center justify-center flex-col"><div className="lds-ripple"><div></div><div></div></div></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 xl:gap-4 gap-y-6 px-4 lg:px-2">
                        {
                            posts.posts.map((post) =>(
                                <div key={post._id}>
                                    <Post post={post} dispatchDelete= {handleDelete} dispatchLike={handleLike} dispatchEdit={handleEditPost}/>
                                </div>
                             ))
                        }
                </div>
